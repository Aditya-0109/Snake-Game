...
# Game Title
pygame.display.set_caption("Aditya_Vijay Game")
pygame.display.update()
clock = pygame.time.Clock()
font = pygame.font.SysFont(None, 55)

def text_screen(text, color, x, y):
    screen_text = font.render(text, True, color) # text store/render
    gameWindow.blit(screen_text, [x,y])  # text stored in screen_text displayed at required coordinates
